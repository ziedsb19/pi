...
class EvenementType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('titre', TextType::class,
            array("label"=>"titre de l'evenement", "attr"=>array("class"=>"form-control ", "placeholder"=>"titre de l'evenement")))
            ->add('date', DateTimeType::class ,
                array("widget"=>"single_text", "html5"=>false ,"label"=>"date de l'evenement", "attr"=>array("class"=>"form-control ","id"=>"form_date")))
            ...
            ->add('adresse', TextType::class,
                array("label"=>"adresse de l'evenement", "attr"=>array("class"=>"form-control ", "placeholder"=>"adresse de l'evenement")))
