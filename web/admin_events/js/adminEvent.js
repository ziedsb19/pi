...
var canvasPi = document.getElementById('piChart');
...
$(document).ready(function () {
    var inscri = Number(canvasPi.dataset.inscri);
    var total = Number(canvasPi.dataset.total);
    var inscrPerTotal = (inscri / total) * 100;
    //@ts-ignore
